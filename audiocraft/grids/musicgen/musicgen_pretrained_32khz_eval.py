...
def explorer(launcher):
    ...
    with launcher.job_array():
        ...
        musicgen_base_small = musicgen_base.bind(
            {"continue_from": "//pretrained/facebook/musicgen-small"}
        )
        eval(musicgen_base_small, batch_size=128)

        musicgen_base_medium = musicgen_base.bind(
        ...
        musicgen_base_large = musicgen_base.bind(
        ...
        musicgen_melody_medium = musicgen_melody.bind(
